        ...
        <div>
            <div className='bg-white rounded-md'>
                ...
                <div className='p-5 mt-[-12px]'>
                    <div className="text-white text-[18px] rounded-md select-none p-2 hover:opacity-90 active:scale-95 cursor-pointer font-[500] flex justify-center items-center bg-main-bg">ĐẶT HÀNG</div>
                </div>
            </div>
        </div>
    );
