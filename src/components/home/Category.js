            ...
            <div className="container_main">
                <div className='bg-white rounded-md'>
                    ...
                    <div className="grid grid-cols-6">
                        <Link className="col-span-1 h-[132px]  border-[1px] border-gray-200 rounde4-sm flex flex-col" to="/danhmuc/Giấy In Ấn - Photo">
                        ...
                        <Link className="col-span-1 h-[132px]   border-[1px] border-gray-200 rounded-sm flex flex-col" to="/danhmuc/Dụng Cụ Văn Phòng Chất Lượng" >
                            <div className='w-[68px] h-[68px] rounded-full mb-1 mx-auto mt-4'>
                        ...
                        <Link className="col-span-1 h-[132px]  border-[1px] border-gray-200 rounded-sm flex flex-col" to="/danhmuc/Bút Mực Chất Lượng">
                            <div className='w-[68px] h-[68px] rounded-full mb-1 mx-auto mt-4'>
                        ...
                        <Link className="col-span-1 h-[132px]  border-[1px] border-gray-200 rounded-sm flex flex-col" to="/danhmuc/Sổ - Tập - Bao Thư">
                            <div className='w-[68px] h-[68px] rounded-full mb-1 mx-auto mt-4'>
                        ...
                        <Link className="col-span-1 h-[132px]  border-[1px] border-gray-200 rounded-sm flex flex-col" to="/danhmuc/Băng Keo - Dao - Kéo">
                            <div className='w-[68px] h-[68px] rounded-full mb-1 mx-auto mt-4'>
                        ...
                        <Link className="col-span-1 h-[132px]  border-[1px] border-gray-200 rounded-sm flex flex-col" to="/danhmuc/Máy tính casio">
                            <div className='w-[68px] h-[68px] rounded-full mb-1 mx-auto mt-4'>
