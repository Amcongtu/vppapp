            ...
            <div className="container_main">
                <div className='bg-white rounded-md'>
                    ...
                    <div className="grid grid-cols-6">
                        <div className="col-span-1 h-[132px]  border-[1px] border-gray-200 rounde4-sm flex flex-col" >
                        ...
                        <div className="col-span-1 h-[132px]   border-[1px] border-gray-200 rounded-sm flex flex-col" >
                            <div className='w-[68px] h-[68px] rounded-full mb-1 mx-auto mt-4'>
